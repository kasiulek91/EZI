...
class Stemmer {
	...
	public Vector<String> stemVector(Vector<String> vectorStrings) {
		Vector<String> newVector = new Vector<String>();
		
		for (String word : vectorStrings) {
			newVector.add(stemString(word));
		}
		return newVector;
	}
	...
	public static void main(String[] args) {
		...
		Stemmer s = new Stemmer();
		args = new String[1];
		args[0] = "C:\\Users\\Kasiulek\\Documents\\documents.txt";
